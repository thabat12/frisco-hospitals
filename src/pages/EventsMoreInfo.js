...
const EventsPageResponsiveWrapper = styled.div`
...
const EventsMoreInfoWidget = styled.div`
    width: 100vw;
    height: 100vh;
`;
...
export default function EventsMoreInfoPage() {
    return (
        <EventsPageResponsiveWrapper>
            <EventsMoreInfoWidget className='whole-page'>
                
            </EventsMoreInfoWidget>
        </EventsPageResponsiveWrapper>
    );
}